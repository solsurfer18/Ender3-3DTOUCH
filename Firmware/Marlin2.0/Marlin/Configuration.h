...
#ifndef MOTHERBOARD
#define MOTHERBOARD BOARD_MELZI_CREALITY//RAMPS_14_EFB
#endif
...
#define Y_PROBE_OFFSET_FROM_EXTRUDER -10.9 // Y offset: -front +behind [the nozzle]
#define Z_PROBE_OFFSET_FROM_EXTRUDER -0.61  // Z offset: -below +above  [the nozzle]
